...
Trả về duy nhất 1 object JSON với cấu trúc mảng "questions". Trả về cấu trúc dưới đây, không kèm markdown \`\`\`json.
{
  "questions": [
    ...
    // Nếu là câu Điền từ kéo thả (Cloze)
    { "type": "cloze", "text": "Đoạn văn chứa phần bị khuyết thay thế bằng ký hiệu ___ (3 dấu gạch dưới).", "options": ["từ đúng", "từ nhiễu 1", "từ nhiễu 2"], "correctAnswer": "từ đúng", "explanation": "Giải thích..." }
  ]
}
`;
